...
const std::string DstarDstarpiFeatureExtractor::candtype_name = "DstarDstarpi";

DstarDstarpiFeatureExtractor::DstarDstarpiFeatureExtractor() : 
  YCandFeatureExtractor(13, 12, 9, 4, 4)  {

  Clear();
}

DstarDstarpiFeatureExtractor::DstarDstarpiFeatureExtractor(std::string &mlsample) :
  YCandFeatureExtractor(13, 12, 9, 4, 4)  {
...
std::string DstarDstarpiFeatureExtractor::get_sql_query_statement() const {
  return YCandFeatureExtractor::get_sql_query_statement(
            candtype_name, mlsample_type);
}

void DstarDstarpiFeatureExtractor::update_features(sqlite3_stmt *stmt) {
