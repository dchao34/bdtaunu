...
const std::string DstarDstarrhoFeatureExtractor::candtype_name = "DstarDstarrho";

DstarDstarrhoFeatureExtractor::DstarDstarrhoFeatureExtractor() : 
  YCandFeatureExtractor(15, 9, 9, 4, 4)  {

  Clear();
}

DstarDstarrhoFeatureExtractor::DstarDstarrhoFeatureExtractor(std::string &mlsample) :
  YCandFeatureExtractor(15, 9, 9, 4, 4)  {
...
std::string DstarDstarrhoFeatureExtractor::get_sql_query_statement() const {
  return YCandFeatureExtractor::get_sql_query_statement(
            candtype_name, mlsample_type);
}

void DstarDstarrhoFeatureExtractor::update_features(sqlite3_stmt *stmt) {
...
std::string DstarDstarrhoFeatureExtractor::get_dat_header() const {
  std::stringstream ss;
  ss << "id" << "|";
  ss << "truth_match" << "|";
  ss << "tag_lp3" << "|";
...
std::string DstarDstarrhoFeatureExtractor::get_dat_line() const {
  std::stringstream ss;
  ss << id << "|";
  ss << truth_match << "|";
  ss << tag_lp3 << "|";
