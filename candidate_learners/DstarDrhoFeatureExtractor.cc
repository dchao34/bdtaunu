...
const std::string DstarDrhoFeatureExtractor::candtype_name = "DstarDrho";
...
DstarDrhoFeatureExtractor::DstarDrhoFeatureExtractor(std::string &mlsample) :
  YCandFeatureExtractor(13, 9, 9, 4, 0)  {
...
std::string DstarDrhoFeatureExtractor::get_sql_query_statement() const {
  return YCandFeatureExtractor::get_sql_query_statement(
            candtype_name, mlsample_type);
}

void DstarDrhoFeatureExtractor::update_features(sqlite3_stmt *stmt) {
